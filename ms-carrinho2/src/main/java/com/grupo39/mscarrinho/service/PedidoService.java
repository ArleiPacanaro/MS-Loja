package com.grupo39.mscarrinho.service;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;

import com.grupo39.mscarrinho.entity.ItemPedido;
import com.grupo39.mscarrinho.entity.Pedido;
import com.grupo39.mscarrinho.repository.PedidoRepository;
...
//
    ...
    private void atualizarEstoqueProdutos(List<ItemPedido> itensPedido) {
        for (ItemPedido itemPedido : itensPedido) {
            ...
            restTemplate.put(
                    "http://localhost:8082/produtos/atualizar/estoque/{produtoId}/{quantidade}",
                    null,
                    idProduto,
                    quantidade
            );
